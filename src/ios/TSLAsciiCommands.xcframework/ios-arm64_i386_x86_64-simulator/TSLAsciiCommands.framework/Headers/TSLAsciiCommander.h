...
#import <TSLAsciiCommands/TSLAsciiCommandExecutorBase.h>
...
/// The protocol string for Accessories that support the UHF ASCII Command set
extern NSString * const TSLAccessoryProtocol_UHF;

/// The protocol string for Accessories that support the HF/LF ASCII Command set
extern NSString * const TSLAccessoryProtocol_HFLF;
...
///
extern NSString * const TSLCommanderStateChangedNotification;
...
///
@property (atomic, readonly, nullable) NSString *lastCommandLine;

///
/// The EAAccessory protocol used to communicate with the currently connected Accessory
///
/// UHF Readers:    TSLAccessoryProtocol_UHF
/// HF/LF Readers: TSLAccessoryProtocol_HFLF
///
@property (atomic, readonly, nullable) NSString *activeProtocol;


///
/// The delegate used to test for supported devices
/// 
@property (nonatomic, readwrite, nullable) Class <TSLAsciiCommanderSupportedDeviceDelegate> supportedDeviceDelegate;
...
///
-(BOOL)connect:(nullable EAAccessory *)accessory;
...
///
-(void)send:(nullable NSString *)line;
