...
///
+(TSL_QtMode)qtModeForParameterValue:(nullable NSString *)value;

///
/// Get the parameter value corresponding to the given TSL_QtMode
///
///@param mode The TSL_QtMode value to be converted
///@return The command parameter value for the given TSL_QtMode or nil if invalid
///
+(nullable NSString *)parameterValueForQtMode:(TSL_QtMode)mode;
...
+(nullable NSString *)descriptionForQtMode:(TSL_QtMode)mode;

///
/// Test the given TSL_QtMode for validity
///
///@param mode The TSL_QtMode value to be tested
///@return YES if the given TSL_QtMode is valid otherwise NO
///
+(BOOL)isValidQtMode:(TSL_QtMode)mode;
