...
///
/// The `TSL_SwitchState` enum is used to specify values for the `state` property - the values are interpreted as follows:
///
...
/// @name TSL_SwitchState helper methods
...
///
+(TSL_SwitchState)switchStateForParameterValue:(nullable NSString *)value;
...
///
+(nullable NSString *)parameterValueForSwitchState:(TSL_SwitchState)state;
...
///
+(nullable NSString *)descriptionForSwitchState:(TSL_SwitchState)state;
