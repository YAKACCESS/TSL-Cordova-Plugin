...
///
+(TSL_DataBank)bankForParameterValue:(nullable NSString *)value;
...
///
+(nullable NSString *)parameterValueForBank:(TSL_DataBank)bank;
...
///
+(nullable NSString *)descriptionForBank:(TSL_DataBank)bank;
