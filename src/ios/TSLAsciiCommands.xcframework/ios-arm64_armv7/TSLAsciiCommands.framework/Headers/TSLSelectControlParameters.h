...
///
+(TSL_SelectTarget)selectTargetForParameterValue:(nullable NSString *)value;
...
+(nullable NSString *)parameterValueForSelectTarget:(TSL_SelectTarget)target;
...
///
+(nullable NSString *)descriptionForSelectTarget:(TSL_SelectTarget)target;
...
///
+(nullable NSString *)descriptionForSelectAction:(TSL_SelectAction)action;
