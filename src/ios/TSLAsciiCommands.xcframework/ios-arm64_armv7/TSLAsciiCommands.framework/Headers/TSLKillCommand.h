...
///
typedef void(^TSLKillTransponderReceivedBlock)(NSString * _Nullable epc, NSNumber * _Nullable crc, NSNumber * _Nullable pc, NSNumber * _Nullable rssi, NSNumber * _Nullable index, BOOL killSucceeded, BOOL moreAvailable);
...
@property (nonatomic, readwrite, nullable) NSString *killPassword;
...
@property (nonatomic, copy, nullable) TSLKillTransponderReceivedBlock transponderReceivedBlock
...
///
/// Warning: When a TSLTransponderDataReceivedBlock is supplied this prevents any TSLKillTransponderReceivedBlock
/// from being invoked
///
