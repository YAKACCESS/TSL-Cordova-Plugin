...
+(TSL_PopLoqMode)popLoqModeForParameterValue:(nullable NSString *)value;
...
///
+(nullable NSString *)parameterValueForPopLoqMode:(TSL_PopLoqMode)mode;
...
+(nullable NSString *)descriptionForPopLoqMode:(TSL_PopLoqMode)mode;
