...
@property (nonatomic, readonly, nullable) NSArray *messages;
...
@property (weak, nonatomic, readwrite, nullable) id<TSLAsciiCommandResponderDelegate> synchronousCommandDelegate;
