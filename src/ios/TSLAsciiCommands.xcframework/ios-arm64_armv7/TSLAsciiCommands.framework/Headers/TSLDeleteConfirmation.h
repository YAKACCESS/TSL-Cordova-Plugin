...
///
+(nullable NSString *)parameterValueForDeleteConfirmation:(TSL_DeleteConfirmation)state;
...
///
+(nullable NSString *)descriptionForDeleteConfirmation:(TSL_DeleteConfirmation)state;
...
///
+(TSL_DeleteConfirmation)deleteConfirmationForParameterValue:(nullable NSString *)value;
