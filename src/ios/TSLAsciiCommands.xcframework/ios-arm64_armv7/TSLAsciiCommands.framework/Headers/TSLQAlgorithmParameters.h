...
///
+(TSL_QAlgorithm)qAlgorithmForParameterValue:(nullable NSString *)value;
...
///
+(nullable NSString *)parameterValueForQAlgorithm:(TSL_QAlgorithm)algorithm;
...
///
+(nullable NSString *)descriptionForQAlgorithm:(TSL_QAlgorithm)algorithm;
