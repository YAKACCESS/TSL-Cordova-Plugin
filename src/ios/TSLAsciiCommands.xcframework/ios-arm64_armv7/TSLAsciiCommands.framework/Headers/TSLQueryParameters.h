...
///
+(TSL_QuerySelect)querySelectForParameterValue:(nullable NSString *)value;
...
///
+(nullable NSString *)parameterValueForQuerySelect:(TSL_QuerySelect)select;
...
+(nullable NSString *)descriptionForQuerySelect:(TSL_QuerySelect)select;
...
///
+(TSL_QuerySession)querySessionForParameterValue:(nullable NSString *)value;
...
///
+(nullable NSString *)parameterValueForQuerySession:(TSL_QuerySession)session;
...
///
+(nullable NSString *)descriptionForQuerySession:(TSL_QuerySession)session;
...
///
+(TSL_QueryTarget)queryTargetForParameterValue:(nullable NSString *)value;
...
///
+(nullable NSString *)parameterValueForQueryTarget:(TSL_QueryTarget)target;
...
///
+(nullable NSString *)descriptionForQueryTarget:(TSL_QueryTarget)target;
